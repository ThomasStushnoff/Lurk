	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Option:Double-Sided:Disabled,Enabled,Flipped Normals,Mirrored Normals:Disabled
				...
				Disabled,disable:RemoveDefine:pragma shader_feature_local _ _DOUBLESIDED_ON
				Enabled,Flipped Normals,Mirrored Normals:SetDefine:pragma shader_feature_local _ _DOUBLESIDED_ON
