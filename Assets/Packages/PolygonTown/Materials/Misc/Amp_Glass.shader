...
Shader "Amp_Glass"
{
	Properties
	{
		...
		_Metallic("Metallic", Float) = 0.725
		_Smoothness("Smoothness", Float) = 0.89
		_Alpha("Alpha", Float) = 0
		_Color0("Color 0", Color) = (0,0,0,0)
		_BaseColorSwap("Base Color Swap", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_BaseColor1 = packedInput.ase_texcoord5.xy * _BaseColor1_ST.xy + _BaseColor1_ST.zw;
				float4 lerpResult17 = lerp( tex2D( _BaseColor1, uv_BaseColor1 ) , _Color0 , _BaseColorSwap);
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_BaseColor1 = packedInput.ase_texcoord2.xy * _BaseColor1_ST.xy + _BaseColor1_ST.zw;
				float4 lerpResult17 = lerp( tex2D( _BaseColor1, uv_BaseColor1 ) , _Color0 , _BaseColorSwap);
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_BaseColor1 = packedInput.ase_texcoord7.xy * _BaseColor1_ST.xy + _BaseColor1_ST.zw;
				float4 lerpResult17 = lerp( tex2D( _BaseColor1, uv_BaseColor1 ) , _Color0 , _BaseColorSwap);
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.RangedFloatNode;14;-384,191;Inherit;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;0;False;0;False;0.89;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-384.9208,266.824;Inherit;False;Property;_Alpha;Alpha;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;18;-769.4342,-244.2615;Inherit;False;Property;_Color0;Color 0;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;19;-795.703,-433.7537;Inherit;True;Property;_BaseColor1;Base Color;1;0;Create;True;0;0;0;False;0;False;-1;None;a21aba4b248900647a5c6c3e84de1ea7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;20;-774.4342,-69.26151;Inherit;False;Property;_BaseColorSwap;Base Color Swap;6;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;17;-321.4343,-288.2615;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;11;-394,-77;Inherit;True;Property;_Normal;Normal;0;0;Create;True;0;0;0;False;0;False;-1;abf5755910bc3cb44b22e16ed69f4e4f;abf5755910bc3cb44b22e16ed69f4e4f;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;12;-388,114;Inherit;False;Property;_Metallic;Metallic;2;0;Create;True;0;0;0;False;0;False;0.725;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=666B2A5EE0414922F3DD4B31CE0586DDDBC407DD